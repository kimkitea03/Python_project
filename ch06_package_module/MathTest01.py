# MathTest01.py
import math # 메스 모듈 임포트

print('math.pi :', math.pi) # 파이 원주율
print('math.e :', math.e)
print('math.pow(2, 10) :', math.pow(2, 10)) # 2의10승
print('math.factorial(5) :', math.factorial(5)) #1부터 5까지 곱하기
...
print('math.log(4, 2) :', math.log(32, 2)) #로그
print('math.log10(100) :', math.log10(1000)) #로그 10
